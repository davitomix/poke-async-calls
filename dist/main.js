...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _fetchAsync_pokeApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchAsync/pokeApi */ \"./src/fetchAsync/pokeApi.js\");\n\n\n// getPokemon('132').then(poke => console.log(poke.name));\nObject(_fetchAsync_pokeApi__WEBPACK_IMPORTED_MODULE_0__[\"getPokemons\"])().then(pokemons => pokemons.map(pokemon => console.log(pokemon.id)));\nObject(_fetchAsync_pokeApi__WEBPACK_IMPORTED_MODULE_0__[\"getPokemonsAbilities\"])().then(pokemons => pokemons.map(pokemon => console.log(pokemon)));\n\n\n\n\n//# sourceURL=webpack:///./src/index.js?");
